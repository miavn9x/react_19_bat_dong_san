...
export default function MediaViewer({ url, type }) {
  ...
  if (type?.startsWith("image/")) return <img src={src} alt="" style={{ width:"100%", height:220, objectFit:"cover", borderRadius:12 }} />;
  if (type?.startsWith("video/")) return <video src={src} controls style={{ width:"100%", height:220, borderRadius:12 }} />;
