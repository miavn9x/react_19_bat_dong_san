...
//             {/* Actions desktop & mobile (icon tài khoản + btn đăng tin desktop) */}
...
//               {/* Account dropdown (hoạt động cả mobile & desktop) */}
...
//                 >
//                   {/* Icon/User bubble */}
//                   <div className="h-8 w-8 rounded-full grid place-items-center bg-gray-100 text-gray-700 font-semibold">
//                     {user ? (
//                       initial
//                     ) : (
//                       // icon user
...
export default function MainLayout() {
  ...
  // ✅ Dùng useAuth thay vì đọc localStorage trực tiếp
